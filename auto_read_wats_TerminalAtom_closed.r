...
#working directory
setwd("/data/SHAKER_POPC_TYLER_Closed3/analysis_waters_GofR_TerminalAtom/")
...
for (AA in seq) {
	...
	tab1 <- paste(AA,i,"_A_C", sep="")
	tab2 <- paste(AA,i,"_B_C", sep="")
	tab3 <- paste(AA,i,"_C_C", sep="")
	tab4 <- paste(AA,i,"_D_C", sep="")
	...
	data_mean <- paste(AA,i,"_wat_mean_C", sep="")
	data_sd <- paste(AA,i,"_wat_sd_C", sep="")
